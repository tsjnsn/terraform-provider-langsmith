...
page_title: "langsmith_chart Data Source - langsmith"
subcategory: ""
description: |-
  Use this data source to look up a LangSmith custom chart by ID. Note: the LangSmith single-chart read endpoint does not return section_id; if you need to reference a chart's section, manage it via the langsmith_chart resource instead.
---

# langsmith_chart (Data Source)
